...
public struct BaudRate: RawRepresentable {
...
public class SerialPort {
    ...
    public func open(receive: Bool = true, transmit: Bool = true) throws {
    ...
    #elseif os(OSX)
        fileDescriptor = Darwin.open(path, readWriteParam | O_NOCTTY | O_EXLOCK)
    #endif
